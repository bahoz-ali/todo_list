...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addData\": () => (/* binding */ addData),\n/* harmony export */   \"createLocalStorage\": () => (/* binding */ createLocalStorage),\n/* harmony export */   \"deleteTask\": () => (/* binding */ deleteTask),\n/* harmony export */   \"getData\": () => (/* binding */ getData),\n/* harmony export */   \"saveTOLocalStorage\": () => (/* binding */ saveTOLocalStorage),\n/* harmony export */   \"updateIndexes\": () => (/* binding */ updateIndexes),\n/* harmony export */   \"updateOneTask\": () => (/* binding */ updateOneTask),\n/* harmony export */   \"updateTasks\": () => (/* binding */ updateTasks)\n/* harmony export */ });\nfunction saveTOLocalStorage() {}\n\nfunction getData(key) {\n  try {\n    return JSON.parse(localStorage.getItem(key));\n  } catch (error) {\n    return localStorage.getItem(key);\n  }\n}\n\nfunction createLocalStorage(key = 'tasks', value = []) {\n  if (!getData(key)) {\n    localStorage.setItem(key, JSON.stringify(value));\n  }\n}\n\nfunction updateTasks(data) {\n  localStorage.setItem('tasks', JSON.stringify(data));\n}\n\nfunction updateIndexes() {\n  let tasks = getData('tasks');\n\n  tasks = tasks.map((task, index) => ({ ...task, index: index + 1 }));\n\n  updateTasks(tasks);\n}\n\nfunction addData(obj) {\n  const tasks = getData('tasks');\n  tasks.push(obj);\n  updateTasks(tasks);\n\n  return tasks;\n}\n\nfunction deleteTask(id) {\n  let tasks = getData('tasks');\n\n  if (typeof id === 'string') id = Number(id);\n\n  tasks = tasks.filter((task) => task.index !== id);\n  updateTasks(tasks);\n  updateIndexes();\n}\n\nfunction updateOneTask(id, description) {\n  if (typeof id === 'string') id = Number(id);\n\n  let tasks = getData('tasks');\n\n  tasks = tasks.map((task) => {\n    if (id === task.index) {\n      return { ...task, description };\n    }\n\n    return task;\n  });\n\n  updateTasks(tasks);\n}\n\n\n//# sourceURL=webpack://todo_list/./src/services.js?");

/***/ }),

/***/ "./src/update_complete.js":
/*!********************************!*\
  !*** ./src/update_complete.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"clearCompleteTasks\": () => (/* binding */ clearCompleteTasks),\n/* harmony export */   \"updateCompleteTask\": () => (/* binding */ updateCompleteTask)\n/* harmony export */ });\n/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services */ \"./src/services.js\");\n/* eslint-disable import/extensions */\n\n\nfunction updateCompleteTask(id, isCompleted = false) {\n  if (id === null) return;\n\n  if (typeof id === 'string') id = Number(id);\n\n  let tasks = (0,_services__WEBPACK_IMPORTED_MODULE_0__.getData)('tasks');\n\n  tasks = tasks.map((task) => {\n    if (id === task.index) {\n      return { ...task, completed: isCompleted };\n    }\n\n    return task;\n  });\n\n  (0,_services__WEBPACK_IMPORTED_MODULE_0__.updateTasks)(tasks);\n}\n\nfunction clearCompleteTasks() {\n  let tasks = (0,_services__WEBPACK_IMPORTED_MODULE_0__.getData)('tasks');\n\n  tasks = tasks.filter((task) => !task.completed);\n\n  (0,_services__WEBPACK_IMPORTED_MODULE_0__.updateTasks)(tasks);\n  (0,_services__WEBPACK_IMPORTED_MODULE_0__.updateIndexes)();\n}\n\n\n//# sourceURL=webpack://todo_list/./src/update_complete.js?");
